...
app.post('/subscribe', async(req, res)  => {
    ...
    const userRef = firebase.firestore().collection('SubscribedUsers').doc('q6BRahcKHP6PpUz4hLNz');

    const nameQueryRes = await userRef.where('name', '==', 'rkavinash@gmail.com').get();
